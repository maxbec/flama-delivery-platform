...
const schemaFiles = {
  ...
  "failure-observation": "failure-observation.schema.json",
  "failure-decision": "failure-decision.schema.json",
  ...
  "rollback-input": "rollback-input.schema.json",
  "rollback-result": "rollback-result.schema.json",
